...
final class GA4_Dynamic_Tracker {
    ...
    public function activate() {
        ...
        if (version_compare(PHP_VERSION, '7.4', '<')) {
            ...
            wp_die(
                esc_html__('GA4 Dynamic Tracker requires PHP 7.4 or higher.', 'ga4-dynamic-tracker'),
        ...
        if (version_compare(get_bloginfo('version'), '5.8', '<')) {
            deactivate_plugins(GA4DT_PLUGIN_BASENAME);
            wp_die(
                esc_html__('GA4 Dynamic Tracker requires WordPress 5.8 or higher.', 'ga4-dynamic-tracker'),
                'Plugin Activation Error',
                ['back_link' => true]
            );
        }
    ...
    public function woocommerce_missing_notice() {
        ...
        <div class="notice notice-error">
            <p><?php esc_html_e('GA4 Dynamic Tracker requires WooCommerce to be installed and active.', 'ga4-dynamic-tracker'); ?></p>
        </div>
        <?php
    }
